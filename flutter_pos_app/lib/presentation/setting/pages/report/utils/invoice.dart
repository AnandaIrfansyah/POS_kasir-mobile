...
class Invoice {
  ...
  static Future<File> generate(
    ...
    return HelperPdfService.saveDocument(
        name:
            'AYAM BAKAR MAKNYUS |  Report | ${DateTime.now().millisecondsSinceEpoch}.pdf',
        pdf: pdf);
  }
    ...
    MemoryImage image,
      ...
      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Column(
          ...
          children: [
            SizedBox(height: 1 * PdfPageFormat.cm),
            Text('AYAM BAKAR MAKNYUS | Report',
                style: TextStyle(
                  fontSize: 20,
                  fontWeight: FontWeight.bold,
                )),
  ...
  static Widget buildFooter() => Column(
        ...
        children: [
          ...
          buildSimpleText(
              title: 'Address',
              value: 'Jl. Pahlawan Blok B No 11, Tengah Tani, Kab. Cirebon, 45153'),
