...
//cashier name
  ...
  Future<List<int>> printOrderV2(
    ...
    bytes += generator.text('Ayam Bakar Maknyus',
        styles: const PosStyles(
          bold: true,
          align: PosAlign.center,
          height: PosTextSize.size1,
    ...
    bytes += generator.text('Jl. Pahlawan Blok B No 11',
        styles: const PosStyles(bold: false, align: PosAlign.center));
    bytes += generator.text('Kab. Cirebon, Tengah Tani',
        styles: const PosStyles(bold: false, align: PosAlign.center));
    bytes += generator.text('anndairfansyah@gmail.com',
        styles: const PosStyles(bold: false, align: PosAlign.center));
    bytes += generator.text('085294095455',
        styles: const PosStyles(bold: false, align: PosAlign.center));
    ...
    bytes += generator.text('Terima Kasih',
        styles: const PosStyles(bold: false, align: PosAlign.center));
    bytes += generator.feed(1);
    bytes += generator.text('instagram: @ayambakarmaknyus',
        styles: const PosStyles(bold: false, align: PosAlign.center));
    bytes += generator.feed(1);
    bytes += generator.text(
